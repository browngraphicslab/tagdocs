        ...
        if (container != null && _anchor != null && !_hidden) {
            if (!_map.getBounds().contains(_anchor)) {  //hide if anchor is anchor latlong on the map
                ...
                if (_options.showCloseButton) {
                    contentContainer.append(window.toStaticHTML("<span id='" + _infoboxContainerId + "_closeBtn' href='javascript:void()' style='position:absolute;right:5px;top:2px;cursor:pointer;font:bold 18px Arial;line-height:12px;'>x</span>"));
