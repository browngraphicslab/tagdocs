...
* can select maxheap or minheap by passing in bool, int max
* heap is the default if no comparison function is provided
* first item of array is the min/max
*/

function binaryHeap(scoreFunction, evalRange) {
    "use strict";
    this.content = [];
    ...
    // Helper function that returns lower and upper bounds of range in
    // object with keys "lowbound" and "upbound". Passed in.
